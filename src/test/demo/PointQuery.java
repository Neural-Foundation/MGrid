 ...
 */
public class PointQuery implements SearchListener, P2PListener {
	...
	protected void storageDemo(Type type) throws IOException{
		...
		Long x2 = 502L;
		Long y2 = 421L;
		BitVector row2 = MGridUtils.HilbertConvertor(x2, y2);
		String rowString2 = row2.toString();
		p2p.index.Query query2 = indexFactory.createQuery(type, rowString2);
		System.out.println("Creating a point query [" + query2.getLowerBound() + ", ("+x2+","+y2+")]");

		System.out.println("Searched for data entries.");
		index.search(query2, this);
	...
	public static void main(String[] args) throws IOException {
		...
		PointQuery storage = new PointQuery();
	...
	//	System.out.println("Search result received:");
		...
		for (Iterator it = results.iterator(); it.hasNext();) {
			...
			System.out.println("key: "+entry.getKey()+" x: "+x+" y: "+y+" id: " + entry.getmPointID()+" in time: "+((endTime-startTime)/1000000)+" ms.");
