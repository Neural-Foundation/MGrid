 ...
 */
public class RangeQuery implements SearchListener, P2PListener {
	...
	private List <IndexEntry> numResult = new ArrayList<IndexEntry>();
	...
	public void run(InetAddress bootIP, int bootPort, Properties properties) {
		...
		// wait for the result set
		System.out.println(count+" hits in time "+ (endTime-startTime) +"ms.");
	...
	protected void storageDemo(Type type) throws IOException {
		// Create a range query to retrieve all data entries with a value
		...
		Long xmax = 50400L;
		Long ymax = 50400L;
		System.out.println("Creating a range query [(" + xmin + "," + ymin
				+ ") , (" + xmax + "," + ymax + ")]");
		
		this.startTime = System.currentTimeMillis();
		hilbertRangeQuery(xmin, xmax, ymin, ymax, indexFactory, type, index,	this);
		
		
		System.out.println("Searched for data entries.");
	...
	public static void main(String[] args) throws IOException {
		...
		RangeQuery storage = new RangeQuery();
	...
	public void newSearchResult(GUID guid, int resultSize) {
		this.endTime = System.currentTimeMillis();
		count+=resultSize;
	//	System.out.println(endTime-startTime+" "+resultSize);
	...
	private static int[][] generateRanges(MultiDimensionalSpec spec,
		...
		// create a range query as (xmin , xmax) (ymin, ymax) 
		// both ends inclusive
	...
	private void hilbertRangeQuery(Long xmin, Long xmax, Long ymin, Long ymax,
		...
		//	System.out.println("Searching bw: "+start.toString()+" "+end.toString());
