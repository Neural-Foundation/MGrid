 ...
 * @version 1.0.0
 */
public class ACKMessage extends PGridMessageImp {
	...
	/**
	 * The acknowledgment code "not superpeer".
	 */
	public static final int CODE_NOT_SUPERPEER = 403;

	/**
	 * The acknowledgment code "behind firewall".
	 */
	public static final int CODE_BEHIND_FIREWALL = 404;
	
	/**
	 * The acknowledgment code indicating NACK.
	 */
	public static final int CODE_NACK = 500;
	/**
