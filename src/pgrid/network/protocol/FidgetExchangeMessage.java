 ...
 * @version 1.0.0
 */
public class FidgetExchangeMessage extends PGridMessageImp {
	 ...
	 */
	public static final String XML_FIDGET_EXCHANGE = "FidgetExchange";
	...
	/**
	 * Timestamp of when this message has been received
	 */
	...
	protected String getXMLMessageName() {
		return XML_FIDGET_EXCHANGE;
	}

	/**
	 * Default constructor
	 */
	public FidgetExchangeMessage() {
	}
	 ...
	 */
	public FidgetExchangeMessage(MessageHeader header) {
		super(header);
	}
	 ...
	 */
	public FidgetExchangeMessage(PGridHost host) {
		super();
	 ...
	 */
	public FidgetExchangeMessage(PGridHost host, XMLRoutingTable routingTable) {
		this(host);
	...
	public synchronized void startElement(String uri, String lName, String qName, Attributes attrs) throws SAXException {
		if (qName.equals(XML_FIDGET_EXCHANGE)) {
	...
	public synchronized String toXMLString(String prefix, String newLine) {
		...
		strBuff.append(prefix).append(XML_ELEMENT_OPEN).append(FidgetExchangeMessage.XML_FIDGET_EXCHANGE); // {prefix}<FidgetExchange GUID="mGUID"
		if (mRoutingTable == null) {
			...
			strBuff.append(prefix).append(XML_ELEMENT_OPEN_END).append(FidgetExchangeMessage.XML_FIDGET_EXCHANGE).append(XML_ELEMENT_CLOSE).append(newLine); // {prefix}</FidgetExchange>{newLine}
