...
/**
 * This class represents a P-Grid NaFTConnectionReversalInitReply message to be used with the P2P interface.
 *
 * @author @author <a href="mailto:<nicolas.bonvin@epfl.ch>">Nicolas Bonvin</a>
 * @version 1.0.0
 */
public class NaFTConnectionReversalInitReplyMessage extends PGridMessageImp {

	/**
	 * A part of the XML string.
	 */
	public static final String XML_NaFT_CONNECTION_REVERSAL_INIT_REPLY = "NaFTConnectionReversalInitReply";
	 ...
	 */
	public Object clone() {
		NaFTConnectionReversalInitReplyMessage msg = (NaFTConnectionReversalInitReplyMessage) super.clone();
		return msg;
	}
	 ...
	 *  Default constructor
	 */
	public NaFTConnectionReversalInitReplyMessage(){
		
	}
	
	public NaFTConnectionReversalInitReplyMessage(MessageHeader header){
		super(header);
	}
	...
	protected String getXMLMessageName() {
		return XML_NaFT_CONNECTION_REVERSAL_INIT_REPLY;
	}
	...
	public void startElement(String uri, String lName, String qName, Attributes attrs) throws SAXException {
		...
		if (qName.equals(XML_NaFT_CONNECTION_REVERSAL_INIT_REPLY)) {
			// Info
		} 
	}
	...
	public String toXMLString(String prefix, String newLine) {
		...
		sb.append(prefix).append(XML_ELEMENT_OPEN).append(XML_NaFT_CONNECTION_REVERSAL_INIT_REPLY).append(XML_ELEMENT_END_CLOSE).append(newLine);
		return sb.toString();
	}
